...
namespace Up2Racev2
{
	public class AutosportNascarViewModel : BaseViewModel
	{
		public AutosportNascarViewModel()
		{
			Title = "Autosport NASCAR";
			Icon = "";
		}
		...
		private async Task ExecuteLoadItemsCommand()
		{
			...
			try
			{
				...
				{
					var feed = "http://www.autosport.com/rss/feed/nascar";
