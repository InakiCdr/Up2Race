...
namespace Up2Racev2
{
	public class AsphaltandrubberViewModel : BaseViewModel
	{
		public AsphaltandrubberViewModel()
		{
			Title = "AsphaltAndRubber";
			Icon = "";
		}
		...
		//gets or sests the selected feed item
		...
		private async Task ExecuteLoadItemsCommand()
		{
			...
			try
			{
				...
				{
					var feed = "https://www.asphaltandrubber.com/feed/";
			...
			if (error)
			{
				...
				await page.DisplayAlert("Error", "Unable to load news.", "Ok");
			}
			IsBusy = false;
		}
		...
		//Método para eliminar algunos tags que no termina de eliminar la clase RemoveTags 
