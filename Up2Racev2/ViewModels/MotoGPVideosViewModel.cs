...
namespace Up2Racev2
{
	public class MotoGPVideosViewModel : BaseViewModel
	{
		//public MotoGPVideosViewModel()
		//{
		//	Title = "MotoGP.com";
		//	Icon = "logo.png";
		//}
		...
		//		{
		//			var feed = "https://www.youtube.com/feeds/videos.xml?channel_id=UC8pYaQzbBBXg9GIOHRvTmDQ";
		...
		//						Image = (string)item.Element(media + "content").Attribute("url"),
