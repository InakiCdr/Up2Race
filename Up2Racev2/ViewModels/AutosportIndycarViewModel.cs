...
namespace Up2Racev2
{
	public class AutosportIndycarViewModel : BaseViewModel
	{
		public AutosportIndycarViewModel()
		{
			Title = "Autosport Indycar";
			Icon = "";
		}
		...
		private async Task ExecuteLoadItemsCommand()
		{
			...
			try
			{
				...
				{
					var feed = "http://www.autosport.com/rss/feed/indycar";
