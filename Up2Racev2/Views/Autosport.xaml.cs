...
namespace Up2Racev2
{
	public partial class Autosport : ContentPage
	{
		AutosportViewModel ViewModel
		{
			get { return BindingContext as AutosportViewModel; }
		}
		...
		public Autosport()
		{
			...
			BindingContext = new AutosportViewModel();
